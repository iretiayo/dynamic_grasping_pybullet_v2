...
if __name__ == "__main__":
    ...
    for object_name in object_names:
        ...
        for i, grasp_eef_in_object in enumerate(grasps_eef):
            pre_grasp_eef_in_object = gu.back_off_pose_2d(pu.split_7d(grasp_eef_in_object), -args.back_off)
            pre_grasp_link6_ref_in_object = gu.change_end_effector_link_pose_2d(pre_grasp_eef_in_object, gu.ee_to_link6_reference)
